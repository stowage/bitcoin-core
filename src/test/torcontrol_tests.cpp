...
BOOST_AUTO_TEST_CASE(util_ParseTorReplyMapping)
{
    ...
    CheckParseTorReplyMapping(
        "Valid=Mapping Bare=\"Escape\\\"", std::map<std::string,std::string>{});
    CheckParseTorReplyMapping(
    ...
    CheckParseTorReplyMapping("ARGS", std::map<std::string,std::string>{});
    CheckParseTorReplyMapping("MORE ARGS", std::map<std::string,std::string>{});
    CheckParseTorReplyMapping("MORE  ARGS", std::map<std::string,std::string>{});
    CheckParseTorReplyMapping("EVEN more=ARGS", std::map<std::string,std::string>{});
    CheckParseTorReplyMapping("EVEN+more ARGS", std::map<std::string,std::string>{});
}
